...
const Dashboard = () => {
  ...
  return (
    loading ? <Loader className="h-screen" /> :
      <div className="flex flex-col  bg-sky-400/100 m-auto p-auto">
        <h1
        ...
        <div
          className="flex overflow-x-scroll pb-5 scrollbar-hide rounded-lg"
        >
          <div className="flex flex-nowrap lg:ml-20 md:ml-10 ml-10 rounded-br-lg-50pc" >
            {
        ...
        <h1
        className="flex py-2 lg:px-10 md:px-10 px-5 lg:mx-20 md:mx-10 mx-5 font-bold text-4xl text-gray-800"
        >
         90's Song
        </h1>
        <div
